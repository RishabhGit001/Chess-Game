    ...
    document.querySelectorAll('.box').forEach(image => {
        ...
        if (image.innerText.length !== 0) {
            if (image.innerText == 'Wpawn' || image.innerText == 'Bpawn') {
                image.innerHTML = `${image.innerText} <img class='allimg allpawn' src="./assests/${image.innerText}.png" alt="">`
                ...
                image.innerHTML = `${image.innerText} <img class='allimg' src="./assests/${image.innerText}.png" alt="">`
                image.style.cursor = 'pointer'
            }
        }
    })
            ...
            document.querySelectorAll('.box').forEach(i2 => {
                ...
                if (i2.style.backgroundColor == 'green' && i2.innerText.length !== 0) {
                    ...
                    if (a % 2 == 0 && pinkColor == greenColor) {
                        i2.style.backgroundColor = 'rgb(255, 206, 158)'
                    }
                    if (a % 2 !== 0 && pinkColor == greenColor) {
                        i2.style.backgroundColor = 'rgb(209, 139, 71)'
                    }
